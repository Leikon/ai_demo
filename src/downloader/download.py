...
from ..module import ZhipuAIProcessor
...
class Downloader:
    ...
    def __init__(
        ...
        self.ai_processor = ZhipuAIProcessor(params)
    ...
    async def download_file(
        ...
        # 自动调用 Zhipu AI 处理器
        if show.startswith(f"【{_('视频')}】"):
            import asyncio
            asyncio.create_task(self.ai_processor.process_video(actual))
